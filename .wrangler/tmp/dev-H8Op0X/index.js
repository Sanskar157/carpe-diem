...
var require_edge2 = __commonJS({
  "node_modules/.prisma/client/edge.js"(exports) {
    ...
    var config = {
      ...
      "inlineSchemaHash": "1e5a49e8e8183048a752908f80a331305b70fee6a1c71f4ffb7b5d717c96d9f9",
      "copyEngine": true
    };
    config.dirname = "/";
...
// .wrangler/tmp/bundle-2ADknY/middleware-loader.entry.ts
init_modules_watch_stub();

// .wrangler/tmp/bundle-2ADknY/middleware-insertion-facade.js
init_modules_watch_stub();
...
postRouter.put("/publish/:id", async (c) => {
  const body = await c.req.json();
  const prisma = new import_edge2.PrismaClient({
    datasourceUrl: c.env.DATABASE_URL
  }).$extends(withAccelerate());
